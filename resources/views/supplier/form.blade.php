        ...
        <form action="post" class="form-horizontal">
            ...
            <div class="modal-body">
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="nama" id="nama" class="form-control" required autofous>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="alamat" id="alamat" class="form-control" required autofous>
                        <span class="help-block with-errors"></span>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="telepon" id="telepon" class="form-control" required autofous>
                        <span class="help-block with-errors"></span>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                ...
                <button  class="btn btn-sm btn-flat btn-default" data-dismiss="modal">Close</button>
            </div>
        </div>
        </form>
    </div>
