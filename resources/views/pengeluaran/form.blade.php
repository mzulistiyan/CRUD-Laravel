        ...
        <form action="post" class="form-horizontal">
            ...
            <div class="modal-body">
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="deskripsi" id="deskripsi" class="form-control" required autofous>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input type="number" name="nominal" id="nominal" class="form-control" required autofous>
                        <span class="help-block with-errors"></span>
                    </div>
                </div>
            </div>
